...
const Sidebar = ({ onLinkClick }) => {
    ...
    return (
        ...
        >
            ...
            <NavLink to="/leave-request" style={linkStyle}onClick={onLinkClick}>📋 Leave Request</NavLink>
            <NavLink to="/payroll" style={linkStyle}onClick={onLinkClick}>💰 Payroll</NavLink>
